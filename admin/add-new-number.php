                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect">
                                    ...
                                    <option value="1">1313</option>
                                    <option value="2">786</option>
                                    <option value="3">420</option>
                                    <option value="4">Mirror</option>
                                    <option value="5">Semimirror</option>
                                    <option value="6">Symmetry</option>
                                    <option value="7">xyxy</option>
                                    <option value="8">xyxyxy</option>
                                    <option value="9">xxyyzz</option>
                                    <option value="10">Tetra</option>
                                    <option value="11">Penta</option>
                                    <option value="12">Hexa</option>
                                </select>
                            </div>
