            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add New Vip Numbers</h1>
                    </div>

                    <!-- Content Row -->
                    <div class="container text-dark border p-5">
                    <form action="csvuploadback.php" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="vip_section"
                                        id="inlineRadio1" value="Gold" required>
                                    <label class="form-check-label" for="inlineRadio1">Gold</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="vip_section"
                                        id="inlineRadio2" value="Premium">
                                    <label class="form-check-label" for="inlineRadio2">Premium</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="dp">Select CSV File:</label>
                                <input type="file" name="file" id="search_text" placeholder="Add Polution policy By CSV file" class="form-control" required />
                            </div>
                            <input type="submit" id="inputEmail" name="Import" class="btn btn-info btn-lg btn-block" value="Submit">
                        </form>
                    </div>
