...
?>
    ...
    <section class="search container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-inline mb-5 px-5">
                <div class="d-inline"><a href="">786 Lover</a></div>
                <div class="d-inline"><a href="">420 Lover</a></div>
                <div class="d-inline"><a href="">000 Lover</a></div>
                <div class="d-inline"><a href="">XY XY</a></div>
                <div class="d-inline"><a href="">XY XY XY</a></div>
                <div class="d-inline"><a href="">XX YY ZZ</a></div>
                <div class="d-inline"><a href="">SemiMirror</a></div>
                <div class="d-inline"><a href="">Mirror</a></div>
            </div>
        </div>
    </section>
    ...
    <section class="my-5 gold container">
        <h2 class="text-center">Category name VIP's</h2>
        <span class="section-separator"></span>

        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                <ul>
                    <li><a class="dropdown-item" href="#">786</a></li>
                    <li><a class="dropdown-item" href="#">1313</a></li>
                    <li><a class="dropdown-item" href="#">Doublets</a></li>
                    <li><a class="dropdown-item" href="#">Triplets</a></li>
                    <li><a class="dropdown-item" href="#">420</a></li>
                    <li><a class="dropdown-item" href="#">xyxy</a></li>
                    <li><a class="dropdown-item" href="#">2213420</a></li>
                    <li><a class="dropdown-item" href="#">Tetra Lover</a></li>
                    <li><a class="dropdown-item" href="#">Penta Lover</a></li>
                    <li><a class="dropdown-item" href="#">Hexa Lover</a></li>
                    <li><a class="dropdown-item" href="#">Mirror</a></li>
                    <li><a class="dropdown-item" href="#">Semimirror</a></li>
                    <li><a class="dropdown-item" href="#">2213420</a></li>
                    <li><a class="dropdown-item" href="#">Symmetry Lover</a></li>
                </ul>
            </div>
            <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-6 my-3">
                        <div class="teamblock-categories">
                            <div class="col-md-12 py-4">
                                <h6 class="my-0 text-left">Mirror</h6>
                                <h6 class="my-0 text-right">Rs. 3000</h6>
                                <hr class="mt-0">
                                <p>9876-5400-00</p>
                                <a href="#" class="m-2">Buy Now</a>
                ...
                <button type="submit" class="m-auto">Load More</button>
            </div>
